...
const previewMessages = [
  ...
  { id: 1, content: "Hey, Long time no see :(", isSent: true }
];
    ...
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-base-content/70">Choose a theme for ypur chat interface</p>
        </div>
                  ...
                  {previewMessages.map((message) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <p
                          className={`text-[10px] mt-1.5 ${message.isSent ? "text-primary/70" : "text-base-content/70"}`}
                        >
                          12.00 PM
                        </p>
                      </div>
